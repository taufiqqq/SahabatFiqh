...
export function CharacterDisplay({ isTalking }: CharacterDisplayProps) {
  ...
  return (
    <div className="fixed bottom-0 left-0 z-40 md:w-64 md:h-64 w-40 h-40 flex flex-col items-center">
      ...
      <div className="absolute top-[3px] left-1/2 -translate-x-1/2 w-48 pointer-events-auto bg-white/90 backdrop-blur rounded-md shadow-md border border-border p-1 z-50">
        <Select
          value={selectedChar}
        ...
        >
          ...
          <SelectContent>
            ...
            <SelectItem value="fiqah">aFiqah (Zakat/Assets Expert)</SelectItem>
          </SelectContent>
        </Select>
      </div>
    </div>
